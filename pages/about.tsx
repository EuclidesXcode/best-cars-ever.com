...
export const aboutData = {
  title: 'Sobre Nós',
  subtitle: 'A melhor coleção de carros do mundo',
  description: 'Descubra os carros mais impressionantes que já foram produzidos. Nossa coleção inclui desde clássicos até as máquinas mais recentes e tecnológicas.',
  facts: [
    'Mais de 100 anos de história automotiva',
    'Carros de mais de 10 marcas diferentes',
    'Velocidades recordes quebradas',
    'Tecnologia de ponta em cada veículo'
  ]
};